...
def load_data(path):
    ...
    for i in range(len(samples)):
        ...
        for new_line in line_data:
            ...
            if sample_line_num < 10:
                new_line = new_line + ' 0' * (10 - sample_line_num) * cur_feature_num  # 补齐特征个数
...
def knn_sklearn(X, y, ks=[3], method=1):  #调整K 距离 距离带权
    ...
    for k in tqdm(ks):
        ...
        cur_score_w = cross_val_score(
            clf_w, X, y, cv=10, scoring='accuracy')
